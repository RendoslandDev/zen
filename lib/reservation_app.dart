...
import 'package:zen/Widget/seats_model.dart';
import 'package:zen/constant.dart';
import 'package:zen/seata_model.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Column(
            children: List.generate(numRow.length, (colIndex) {
              int numCol =
          ...
          const Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              SeatStatus(color: grey, status: 'Available'),
              SizedBox(width: 10),
              SeatStatus(color: buttonColor, status: 'Selected'),
              SizedBox(width: 10),
